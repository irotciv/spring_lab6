...
import com.example.springLab6.service.MenuItemsService;
...
@OpenAPIDefinition(
        info = @Info(
                ...
                description = "Documentation of RESTful webservice in Lab6",
                version = "v.1.0.0"
        )
)
...
//    @Parameter(name = "menuItem", description = "New menu item")
    ...
    ResponseEntity<?> createNewMenuItem(@Valid MenuItems menuItem) {
        MenuItems newMenuItem = menuItemsService.saveMenuItem(menuItem);
